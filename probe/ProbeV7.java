...
/** ProbeV7: 50MP with sensorPixelMode=1 (remosaic) + secondary streams like Expert RAW uses. */
public final class ProbeV7 {
    ...
    public static void main(String[] args) {
        try {
            ...
            init();
            // A: RAW10 50MP usage2 + preview YUV usage1 (no sensorPixelMode)
            attempt("A: raw50+preview1920", "0", P_HIGHRES,
                new int[][]{{37, 8160, 6120, 2, 0}, {35, 1920, 1440, 1, 0}}, 5, 40, 2, CameraDevice.TEMPLATE_PREVIEW);
            // B: RAW10 50MP usage2 + preview YUV 4080x3060 usage1
            attempt("B: raw50+preview4080", "0", P_HIGHRES,
                new int[][]{{37, 8160, 6120, 2, 0}, {35, 4080, 3060, 1, 0}}, 5, 40, 2, CameraDevice.TEMPLATE_PREVIEW);
            // C: same as A but ssm_shot_mode=0
            String p0 = P_HIGHRES.replace("ssm_shot_mode=2", "ssm_shot_mode=0");
            attempt("C: raw50+prev ssm0", "0", p0,
                new int[][]{{37, 8160, 6120, 2, 0}, {35, 1920, 1440, 1, 0}}, 5, 40, 0, CameraDevice.TEMPLATE_PREVIEW);
            // D: no setParameters at all, just streams (isolate param dependency)
            attempt("D: raw50+prev noparam", "0", null,
                new int[][]{{37, 8160, 6120, 2, 0}, {35, 1920, 1440, 1, 0}}, 5, null, null, CameraDevice.TEMPLATE_PREVIEW);
        } catch (Throwable t) {
            t.printStackTrace();
        }
        System.exit(0);
